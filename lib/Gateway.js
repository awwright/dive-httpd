...
Gateway.prototype.render = function render(resource, req){
	...
	for(var i=0; i<req.rawHeaders.length; i+=2){
		...
		if(ignoreHeaders.has(n.toLowerCase())) continue;
	...
	if(req.payload){
		...
		downstreamRequest.removeHeader('Content-Length');
		downstreamRequest.removeHeader('Transfer-Encoding');
...
Gateway.prototype.custom = Gateway.prototype.render;
