...
// 1. Call an return next() to defer the request to a downstream route; will resolve to `res` when the request is completed.
RouteURITemplate.prototype.request = function request(req, res, next){
