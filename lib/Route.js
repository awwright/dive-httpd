...
function Route(opts){
	...
	if(opts && typeof opts=='object'){
		...
		if(typeof opts.uriTemplateRoute=='object') this.uriTemplateRoute = opts.uriTemplateRoute;
		else if(opts.uriTemplateRoute) throw new Error('options.uriTemplateRoute must be an object');
	...
	if(this.uriTemplate && !this.uriTemplateRoute){
		this.uriTemplateRoute = new TemplateRouter.Route(this.uriTemplate);
	}
	if(!this.uriTemplate && this.uriTemplateRoute){
		this.uriTemplate = this.uriTemplateRoute.uriTemplate;
	}
}
...
Route.prototype.matchUri = function matchUri(uri){
	if(typeof uri==='object'){
		if(uri.uri && uri.uriTemplate){
			...
			const route = this.uriTemplateRoute;
			if(!this.uriTemplateRouter){
				this.uriTemplateRouter = new TemplateRouter.Router();
				this.uriTemplateRouter.addTemplate(this.uriTemplateRoute);
			}
