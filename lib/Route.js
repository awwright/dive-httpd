...
function Route(opts){
	...
	if(opts && typeof opts=='object'){
		...
		else if(opts.uriTemplate) throw new Error('options.uriTemplate must be a string');
		...
		else if(opts.prepareMatch) throw new Error('options.prepareMatch must be a function');
