...
RouteStaticFile.prototype.prepare = function prepare(match, euri, queryMap){
	...
	return new Promise(function(resolve, reject){
		...
		stream.on('open', function(err){
			var rr = new self.resourceType(self, stream);
...
function ResourceStaticFile(route, stream){
	if(!(this instanceof ResourceStaticFile)) return new ResourceStaticFile(route, stream);
	this.route = route;
	this.stream = stream;
}
