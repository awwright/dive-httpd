...
NegotiateResource.prototype.render = function render(req){
	...
	return resourceResource.render.apply(resourceResource, arguments).pipe(new ServerResponseTransform({
		transformHead: function _transformHead(headers){
			headers.setHeader('Content-Location', resourceResource.uri);
